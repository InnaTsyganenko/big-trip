...
/* harmony import */ var _view_edit_point_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/edit-point-view */ "./src/view/edit-point-view.js");
...
var _handleDeletePointClick = /*#__PURE__*/new WeakMap();
...
class AddPointPresenter {
  constructor(pointListContainer, pointsLength) {
    ...
    _classPrivateFieldInitSpec(this, _handleDeletePointClick, {
      writable: true,
      value: () => {
        this.closeAddForm();
    ...
    _defineProperty(this, "closeAddForm", () => {
      if (_classPrivateFieldGet(this, _mode) === ModeAddPoint.SHOW) {
        ...
        if (_classPrivateFieldGet(this, _pointsLength) === 0) {
          _classPrivateFieldGet(this, _siteMainElement).querySelector('.trip-events__msg').style = 'display: block;';
        }
      }
    });
  ...
  init(point) {
    ...
    _classPrivateFieldSet(this, _addPointComponent, new _view_edit_point_view__WEBPACK_IMPORTED_MODULE_3__["default"](point));

    _classPrivateFieldGet(this, _addPointButton).addEventListener('click', () => {
      _classPrivateFieldSet(this, _mode, ModeAddPoint.SHOW);

      if (_classPrivateFieldGet(this, _pointListContainer) && _classPrivateFieldGet(this, _pointListContainer).element.querySelector('.event--edit')) {
        _classPrivateFieldGet(this, _pointListContainer).element.querySelector('.event--edit').querySelector('.event__rollup-btn').click();
      }

      if (_classPrivateFieldGet(this, _body).querySelector('.trip-events__msg')) {
        _classPrivateFieldGet(this, _body).querySelector('.trip-events__msg').style = 'display: none;';
      }
    ...
    _classPrivateFieldGet(this, _addPointComponent).setDeletePointHandler(_classPrivateFieldGet(this, _handleDeletePointClick));
  }
...
class Point {
  constructor(pointListContainer, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _replaceCardToForm, {
      writable: true,
      value: () => {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _pointEditComponent), _classPrivateFieldGet(this, _pointComponent));
    ...
    _classPrivateFieldInitSpec(this, _replaceFormToCard, {
      writable: true,
      value: () => {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _pointComponent), _classPrivateFieldGet(this, _pointEditComponent));
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, Object.assign({}, _classPrivateFieldGet(this, _point), {
    ...
    _classPrivateFieldInitSpec(this, _handleDeletePointClick, {
      writable: true,
      value: () => {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.remove)(_classPrivateFieldGet(this, _pointEditComponent));
    ...
    _classPrivateFieldSet(this, _siteTripEventsElement, bodyElement.querySelector('.trip-events'));

    _classPrivateFieldSet(this, _pointComponent, null);
  ...
  init(point) {
    ...
    _classPrivateFieldSet(this, _pointComponent, new _view_point_view__WEBPACK_IMPORTED_MODULE_3__["default"](point));

    _classPrivateFieldSet(this, _pointEditComponent, new _view_edit_point_view__WEBPACK_IMPORTED_MODULE_4__["default"](point));
    ...
    _classPrivateFieldGet(this, _pointEditComponent).setDeletePointHandler(_classPrivateFieldGet(this, _handleDeletePointClick));

    _classPrivateFieldGet(this, _pointEditComponent).setFormHideEditHandler(_classPrivateFieldGet(this, _handleHideEditClick));

    if (prevPointComponent === null || prevPointEditComponent === null) {
      (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.render)(_classPrivateFieldGet(this, _pointListContainer), _classPrivateFieldGet(this, _pointComponent), _utils_render__WEBPACK_IMPORTED_MODULE_1__.RenderPosition.BEFOREEND);
      return;
    }

    if (_classPrivateFieldGet(this, _mode) === Mode.DEFAULT) {
      (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _pointComponent), prevPointComponent);
    }

    if (_classPrivateFieldGet(this, _mode) === Mode.EDITING) {
      (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _pointEditComponent), prevPointEditComponent);
    }
  ...
  destroy() {
    (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.remove)(_classPrivateFieldGet(this, _pointComponent));
    (0,_utils_render__WEBPACK_IMPORTED_MODULE_1__.remove)(_classPrivateFieldGet(this, _pointEditComponent));
  }
...
var _addPoint = /*#__PURE__*/new WeakMap();
...
class TripEvents {
  constructor(tripContainer) {
    ...
    _classPrivateFieldInitSpec(this, _addPoint, {
      writable: true,
      value: {}
    });
    ...
    _classPrivateFieldInitSpec(this, _handlePointChange, {
      ...
      value: updatedPoint => {
        ...
        _classPrivateFieldSet(this, _sourcedPoints, (0,_utils_common__WEBPACK_IMPORTED_MODULE_0__.updateItem)(_classPrivateFieldGet(this, _points), updatedPoint));
    ...
    _classPrivateFieldInitSpec(this, _sortPoints, {
      ...
      value: sortType => {
        switch (sortType) {
          case `sort-${_const__WEBPACK_IMPORTED_MODULE_2__.SortType.TIME}`:
            _classPrivateFieldGet(this, _points).sort((a, b) => b.duration - a.duration);

            break;

          case `sort-${_const__WEBPACK_IMPORTED_MODULE_2__.SortType.PRICE}`:
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_sort_view__WEBPACK_IMPORTED_MODULE_3__["default"]());
    ...
    _classPrivateFieldInitSpec(this, _renderAddPoint, {
      ...
      value: () => {
        ...
        addPointPresenter.init(_classPrivateFieldGet(this, _addPoint)[0]);
    ...
    _classPrivateFieldInitSpec(this, _renderPoints, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _points).forEach(point => _classPrivateFieldGet(this, _renderPoint).call(this, point));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripEvents, {
      ...
      value: () => {
        if (_classPrivateFieldGet(this, _points).length > 0) {
          ...
          _classPrivateFieldGet(this, _renderNoPointsList).call(this);
        }
  ...
  init(points) {
    _classPrivateFieldSet(this, _points, points.slice(0, _classPrivateFieldGet(this, _points).length - 1));

    _classPrivateFieldSet(this, _sourcedPoints, points.slice(0, _classPrivateFieldGet(this, _points).length - 1));

    _classPrivateFieldSet(this, _addPoint, points.slice(0, 1));
...
const isEscEvent = evt => evt.key === ('Escape' || 0);
...
var _citiesInputHandler = /*#__PURE__*/new WeakMap();

var _selectOptionHandler = /*#__PURE__*/new WeakMap();
...
class EditPointView extends _smart_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(point) {
    ...
    _defineProperty(this, "removeElement", () => {
      ...
      if (_classPrivateFieldGet(this, _datepicker)) {
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      ...
      value: () => {
        ...
        this.element.querySelector('.event__input--destination').addEventListener('change', _classPrivateFieldGet(this, _citiesInputHandler));
        this.element.querySelectorAll('.event__offer-checkbox').forEach(item => item.addEventListener('change', _classPrivateFieldGet(this, _selectOptionHandler)));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _citiesInputHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
    ...
    _classPrivateFieldInitSpec(this, _selectOptionHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
...
const createSortingTemplate = sorts => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
  ...
  <input id="sort-${sort}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-${sort}" ${sort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY ? 'checked' : ''} ${sort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.EVENT || sort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.OFFERS ? 'disabled' : ''}>
  <label class="trip-sort__btn" for="sort-${sort}">${sort}</label>
</div>`).join('')}
    </form>`;

var _sortValues = /*#__PURE__*/new WeakMap();
...
class SortView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _sortValues, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldSet(this, _sortValues, Array.from(Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType)));
  }

  get template() {
    return createSortingTemplate(_classPrivateFieldGet(this, _sortValues));
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
